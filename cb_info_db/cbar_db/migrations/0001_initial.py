# -*- coding: utf-8 -*-
# Generated by Django 1.9.1 on 2016-03-18 21:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mount_stationary_block', models.CharField(choices=[('R', 'Ramp'), ('T', 'Over crest'), ('P', 'Over croup')], max_length=1, null=True)),
                ('dismount_assistance_required', models.CharField(choices=[('I', 'Independent'), ('M', 'Minimal assistance'), ('F', 'Full assistance')], max_length=1)),
                ('dismount_type', models.CharField(choices=[('A', 'Over croup'), ('B', 'Over croup with left foot in stirrup'), ('C', 'Over crest and flip'), ('D', 'Over crest and hip')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proper_lead_canter', models.CharField(blank=True, choices=[('U', 'Unsatisfactory'), ('P', 'Poor'), ('F', 'Fair'), ('G', 'Good'), ('E', 'Excellent'), ('N', 'Rider not able to perform due to disability'), ('A', 'Attempts'), ('P', 'Partially completes')], max_length=1)),
