# -*- coding: utf-8 -*-
# Generated by Django 1.9.1 on 2016-04-10 20:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('num_sidewalkers_walk_spotter', models.DecimalField(decimal_places=0, max_digits=1)),
                ('num_sidewalkers_walk_heel_hold', models.DecimalField(decimal_places=0, max_digits=1)),
                ('num_sidewalkers_walk_over_thigh', models.DecimalField(decimal_places=0, max_digits=1)),
                ('num_sidewalkers_walk_other', models.DecimalField(decimal_places=0, max_digits=1)),
                ('num_sidewalkers_trot_spotter', models.DecimalField(decimal_places=0, max_digits=1)),
                ('num_sidewalkers_trot_heel_hold', models.DecimalField(decimal_places=0, max_digits=1)),
                ('num_sidewalkers_trot_over_thigh', models.DecimalField(decimal_places=0, max_digits=1)),
                ('num_sidewalkers_trot_other', models.DecimalField(decimal_places=0, max_digits=1)),
            ],
        ),
        migrations.CreateModel(
            name='AuthorizedUser',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('allergies_conditions_that_exclude', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')])),
                ('allergies_conditions_that_exclude_description', models.CharField(max_length=500, null=True)),
                ('heat_exhaustion_stroke', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')])),
                ('tetanus_shot_last_ten_years', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')])),
                ('seizures_last_six_monthes', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')])),
                ('doctor_concered_re_horse_activites', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')])),
                ('physical_or_mental_issues_affecting_riding', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')])),
                ('physical_or_mental_issues_affecting_riding_description', models.CharField(max_length=500, null=True)),
                ('restriction_for_horse_activity_last_five_years', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')])),
                ('restriction_for_horse_activity_last_five_years_description', models.CharField(max_length=500, null=True)),
                ('present_restrictions_for_horse_activity', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')])),
                ('limiting_surgeries_last_six_monthes', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')])),
                ('limiting_surgeries_last_six_monthes_description', models.CharField(max_length=500, null=True)),
                ('signature', models.CharField(max_length=75)),
                ('currently_taking_any_medication', models.BooleanField(choices=[(True, 'Yes'), (False, 'No')])),
            ],
        ),
        migrations.CreateModel(
            name='Medication',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_cell', models.CharField(max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action_to_take_allow_time_how_long', models.DecimalField(decimal_places=0, max_digits=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=50)),
                ('seizure_eval', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cbar_db.SeizureEval')),
            ],
        ),
        migrations.CreateModel(
            name='Session',
