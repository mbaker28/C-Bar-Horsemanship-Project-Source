        ...
        if form.is_valid():
            ...
            try:
                form_data_rider_eval_checklist=models.EvalRidingExercises(
                    ...
                    circle_trot_no_stirrups=form.cleaned_data["circle_trot_no_stirrups"],
                    circle_at_canter=form.cleaned_data["circle_at_canter"],
                    circle_canter_no_stirrups=form.cleaned_data["circle_canter_no_stirrups"],
                    ...
                    holds_handhold_walk=form.cleaned_data["holds_handhold_walk"],
                    holds_handhold_sit_trot=form.cleaned_data["holds_handhold_sit_trot"],
                    holds_handhold_post_trot=form.cleaned_data["holds_handhold_post_trot"],
                    holds_handhold_canter=form.cleaned_data["holds_handhold_canter"],
                    holds_reins_walk=form.cleaned_data["holds_reins_walk"],
                    holds_reins_sit_trot=form.cleaned_data["holds_reins_sit_trot"],
                    holds_reins_post_trot=form.cleaned_data["holds_reins_post_trot"],
                    holds_reins_canter=form.cleaned_data["holds_reins_canter"],
                    shorten_lengthen_reins_walk=form.cleaned_data["shorten_lengthen_reins_walk"],
                    shorten_lengthen_reins_sit_trot=form.cleaned_data["shorten_lengthen_reins_sit_trot"],
                    shorten_lengthen_reins_post_trot=form.cleaned_data["shorten_lengthen_reins_post_trot"],
                    shorten_lengthen_reins_canter=form.cleaned_data["shorten_lengthen_reins_canter"],
                    can_control_horse_walk=form.cleaned_data["can_control_horse_walk"],
                    can_control_horse_sit_trot=form.cleaned_data["can_control_horse_sit_trot"],
                    can_control_horse_post_trot=form.cleaned_data["can_control_horse_post_trot"],
                    can_control_horse_canter=form.cleaned_data["can_control_horse_canter"],
                    can_halt_walk=form.cleaned_data["can_halt_walk"],
                    can_halt_sit_trot=form.cleaned_data["can_halt_sit_trot"],
                    can_halt_post_trot=form.cleaned_data["can_halt_post_trot"],
                    can_halt_canter=form.cleaned_data["can_halt_canter"],
                    drop_pickup_stirrups_walk=form.cleaned_data["drop_pickup_stirrups_walk"],
                    drop_pickup_stirrups_sit_trot=form.cleaned_data["drop_pickup_stirrups_sit_trot"],
                    drop_pickup_stirrups_post_trot=form.cleaned_data["drop_pickup_stirrups_post_trot"],
                    drop_pickup_stirrups_canter=form.cleaned_data["drop_pickup_stirrups_canter"],
                    rides_no_stirrups_walk=form.cleaned_data["rides_no_stirrups_walk"],
                    rides_no_stirrups_sit_trot=form.cleaned_data["rides_no_stirrups_sit_trot"],
                    rides_no_stirrups_post_trot=form.cleaned_data["rides_no_stirrups_post_trot"],
                    rides_no_stirrups_canter=form.cleaned_data["rides_no_stirrups_canter"],
                    maintain_half_seat_walk=form.cleaned_data["maintain_half_seat_walk"],
                    maintain_half_seat_sit_trot=form.cleaned_data["maintain_half_seat_sit_trot"],
                    maintain_half_seat_post_trot=form.cleaned_data["maintain_half_seat_post_trot"],
                    maintain_half_seat_canter=form.cleaned_data["maintain_half_seat_canter"],
                    can_post_walk=form.cleaned_data["can_post_walk"],
                    can_post_sit_trot=form.cleaned_data["can_post_sit_trot"],
                    can_post_post_trot=form.cleaned_data["can_post_post_trot"],
                    can_post_canter=form.cleaned_data["can_post_canter"],
                    proper_diagonal_walk=form.cleaned_data["proper_diagonal_walk"],
                    proper_diagonal_sit_trot=form.cleaned_data["proper_diagonal_sit_trot"],
                    proper_diagonal_post_trot=form.cleaned_data["proper_diagonal_post_trot"],
                    proper_diagonal_canter=form.cleaned_data["proper_diagonal_canter"],
                    proper_lead_canter_sees=form.cleaned_data["proper_lead_canter_sees"],
                    proper_lead_canter_knows=form.cleaned_data["proper_lead_canter_knows"],
                    can_steer_over_cavalletti_walk=form.cleaned_data["can_steer_over_cavalletti_walk"],
                    can_steer_over_cavalletti_sit_trot=form.cleaned_data["can_steer_over_cavalletti_sit_trot"],
                    can_steer_over_cavalletti_post_trot=form.cleaned_data["can_steer_over_cavalletti_post_trot"],
                    can_steer_over_cavalletti_canter=form.cleaned_data["can_steer_over_cavalletti_canter"],
                    jump_crossbar_walk=form.cleaned_data["jump_crossbar_walk"],
                    jump_crossbar_sit_trot=form.cleaned_data["jump_crossbar_sit_trot"],
                    jump_crossbar_post_trot=form.cleaned_data["jump_crossbar_post_trot"],
                    jump_crossbar_canter=form.cleaned_data["jump_crossbar_canter"],
                    basic_trail_rules_com=form.cleaned_data["basic_trail_rules_com"],
                    mount_com=form.cleaned_data["mount_com"],
                    dismount_com=form.cleaned_data["dismount_com"],
                    emergency_dismount_com=form.cleaned_data["emergency_dismount_com"],
                    four_natural_aids_com=form.cleaned_data["four_natural_aids_com"],
                    basic_control_com=form.cleaned_data["basic_control_com"],
                    reverse_at_walk_com=form.cleaned_data["reverse_at_walk_com"],
                    reverse_at_trot_com=form.cleaned_data["reverse_at_trot_com"],
                    never_ridden_com=form.cleaned_data["never_ridden_com"],
                    seat_at_walk_com=form.cleaned_data["seat_at_walk_com"],
                    seat_at_trot_com=form.cleaned_data["seat_at_trot_com"],
                    seat_at_canter_com=form.cleaned_data["seat_at_canter_com"],
                    basic_seat_english_com=form.cleaned_data["basic_seat_english_com"],
                    basic_seat_western_com=form.cleaned_data["basic_seat_western_com"],
                    hand_pos_english_com=form.cleaned_data["hand_pos_english_com"],
                    hand_post_western_com=form.cleaned_data["hand_post_western_com"],
                    two_point_trot_com=form.cleaned_data["two_point_trot_com"],
                    circle_trot_no_stirrups_com=form.cleaned_data["circle_trot_no_stirrups_com"],
                    circle_at_canter_com=form.cleaned_data["circle_at_canter_com"],
                    circle_canter_no_stirrups_com=form.cleaned_data["circle_canter_no_stirrups_com"],
                    two_point_canter_com=form.cleaned_data["two_point_canter_com"],
                    circle_at_walk_com=form.cleaned_data["circle_at_walk_com"],
                    circle_at_trot_com=form.cleaned_data["circle_at_trot_com"],
                    holds_handhold_walk_com=form.cleaned_data["holds_handhold_walk_com"],
                    holds_handhold_sit_trot_com=form.cleaned_data["holds_handhold_sit_trot_com"],
                    holds_handhold_post_trot_com=form.cleaned_data["holds_handhold_post_trot_com"],
                    holds_handhold_canter_com=form.cleaned_data["holds_handhold_canter_com"],
                    holds_reins_walk_com=form.cleaned_data["holds_reins_walk_com"],
                    holds_reins_sit_trot_com=form.cleaned_data["holds_reins_sit_trot_com"],
                    holds_reins_post_trot_com=form.cleaned_data["holds_reins_post_trot_com"],
                    holds_reins_canter_com=form.cleaned_data["holds_reins_canter_com"],
                    shorten_lengthen_reins_walk_com=form.cleaned_data["shorten_lengthen_reins_walk_com"],
                    shorten_lengthen_reins_sit_trot_com=form.cleaned_data["shorten_lengthen_reins_sit_trot_com"],
                    shorten_lengthen_reins_post_trot_com=form.cleaned_data["shorten_lengthen_reins_post_trot_com"],
                    shorten_lengthen_reins_canter_com=form.cleaned_data["shorten_lengthen_reins_canter_com"],
                    can_control_horse_walk_com=form.cleaned_data["can_control_horse_walk_com"],
                    can_control_horse_sit_trot_com=form.cleaned_data["can_control_horse_sit_trot_com"],
                    can_control_horse_post_trot_com=form.cleaned_data["can_control_horse_post_trot_com"],
                    can_control_horse_canter_com=form.cleaned_data["can_control_horse_canter_com"],
                    can_halt_walk_com=form.cleaned_data["can_halt_walk_com"],
                    can_halt_sit_trot_com=form.cleaned_data["can_halt_sit_trot_com"],
                    can_halt_post_trot_com=form.cleaned_data["can_halt_post_trot_com"],
                    can_halt_canter_com=form.cleaned_data["can_halt_canter_com"],
                    drop_pickup_stirrups_walk_com=form.cleaned_data["drop_pickup_stirrups_walk_com"],
                    drop_pickup_stirrups_sit_trot_com=form.cleaned_data["drop_pickup_stirrups_sit_trot_com"],
                    drop_pickup_stirrups_post_trot_com=form.cleaned_data["drop_pickup_stirrups_post_trot_com"],
                    drop_pickup_stirrups_canter_com=form.cleaned_data["drop_pickup_stirrups_canter_com"],
                    rides_no_stirrups_walk_com=form.cleaned_data["rides_no_stirrups_walk_com"],
                    rides_no_stirrups_sit_trot_com=form.cleaned_data["rides_no_stirrups_sit_trot_com"],
                    rides_no_stirrups_post_trot_com=form.cleaned_data["rides_no_stirrups_post_trot_com"],
                    rides_no_stirrups_canter_com=form.cleaned_data["rides_no_stirrups_canter_com"],
                    maintain_half_seat_walk_com=form.cleaned_data["maintain_half_seat_walk_com"],
                    maintain_half_seat_sit_trot_com=form.cleaned_data["maintain_half_seat_sit_trot_com"],
                    maintain_half_seat_post_trot_com=form.cleaned_data["maintain_half_seat_post_trot_com"],
                    maintain_half_seat_canter_com=form.cleaned_data["maintain_half_seat_canter_com"],
                    can_post_walk_com=form.cleaned_data["can_post_walk_com"],
                    can_post_sit_trot_com=form.cleaned_data["can_post_sit_trot_com"],
                    can_post_post_trot_com=form.cleaned_data["can_post_post_trot_com"],
                    can_post_canter_com=form.cleaned_data["can_post_canter_com"],
                    proper_diagonal_walk_com=form.cleaned_data["proper_diagonal_walk_com"],
                    proper_diagonal_sit_trot_com=form.cleaned_data["proper_diagonal_sit_trot_com"],
                    proper_diagonal_post_trot_com=form.cleaned_data["proper_diagonal_post_trot_com"],
                    proper_diagonal_canter_com=form.cleaned_data["proper_diagonal_canter_com"],
                    proper_lead_canter_sees_com=form.cleaned_data["proper_lead_canter_sees_com"],
                    proper_lead_canter_knows_com=form.cleaned_data["proper_lead_canter_knows_com"],
                    can_steer_over_cavalletti_walk_com=form.cleaned_data["can_steer_over_cavalletti_walk_com"],
                    can_steer_over_cavalletti_sit_trot_com=form.cleaned_data["can_steer_over_cavalletti_sit_trot_com"],
                    can_steer_over_cavalletti_post_trot_com=form.cleaned_data["can_steer_over_cavalletti_post_trot_com"],
                    can_steer_over_cavalletti_canter_com=form.cleaned_data["can_steer_over_cavalletti_canter_com"],
                    jump_crossbar_walk_com=form.cleaned_data["jump_crossbar_walk_com"],
                    jump_crossbar_sit_trot_com=form.cleaned_data["jump_crossbar_sit_trot_com"],
                    jump_crossbar_post_trot_com=form.cleaned_data["jump_crossbar_post_trot_com"],
                    jump_crossbar_canter_com=form.cleaned_data["jump_crossbar_canter_com"]
                )
