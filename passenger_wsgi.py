...
sys.path.insert(0,'$HOME/db.cbarhorsemanship.org/env/lib/python3.4/site-packages/django')
sys.path.insert(0,'$HOME/db.cbarhorsemanship.org/env/lib/python3.4/site-packages')
